...
#include <MLCB.h>               // abstract base class
#include <MLCB2515.h>           // header for this class
...
static const uint32_t CANBITRATE = 125000UL;                // 125Kb/s - fixed for MLCB
static const uint32_t OSCFREQ = 16000000UL;                 // crystal frequency default

//
/// an implementation of the absract base MLCB class
/// to support the MCP2515/25625 CAN controllers
//

class MLCB2515 : public MLCBbase {

public:

  MLCB2515();
  MLCB2515(MLCBConfig *the_config);
  ...
  // they are not declared or implemented by the base MLCB class
