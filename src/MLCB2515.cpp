...
bool MLCB2515::begin(bool poll, SPIClassRP2040 spi)
#else
bool MLCB2515::begin(bool poll, SPIClass spi)
#endif
{
  uint16_t ret;
  bool retval = false;
...
CANFrame MLCB2515::getNextMessage(void) {
...
bool MLCB2515::sendMessage(CANFrame *msg, bool rtr, bool ext, byte priority) {
...
#ifdef ARDUINO_ARCH_RP2040
void MLCB2515::setPins(byte cs_pin, byte int_pin, byte mosi_pin, byte miso_pin, byte sck_pin)
#else
void MLCB2515::setPins(byte cs_pin, byte int_pin)
#endif
{
...
void MLCB2515::setNumBuffers(byte num_rx_buffers, byte num_tx_buffers) {
...
void MLCB2515::setOscFreq(unsigned long freq) {
  _osc_freq = freq;
}
